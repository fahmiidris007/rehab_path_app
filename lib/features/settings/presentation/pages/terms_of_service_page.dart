        ...
        child: Column(
          ...
          children: [
            ...
            _Section(
              ...
              body:
                  'By accessing or using the RehabPath application, you agree to be bound by these Terms of Service. '
                  'If you do not agree to these terms, please do not use our application.',
            ),
            _Section(
              title: '2. Medical Disclaimer',
              body:
                  'RehabPath is designed to support rehabilitation exercises and is not a substitute for '
            ...
            _Section(
              ...
              body:
                  'All content, features, and functionality of the RehabPath application are owned by '
                  'RehabPath and are protected by applicable intellectual property laws. '
                  'You may not reproduce, distribute, or create derivative works without our express permission.',
            ),
            _Section(
              title: '6. Limitation of Liability',
              body:
                  'To the maximum extent permitted by law, RehabPath shall not be liable for any indirect, '
